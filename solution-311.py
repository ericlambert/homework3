...
# miles driven and gallons used for each tankful. Develop a 
# sentinel-controlled-repetition script that prompts the user to input 
# the miles driven and gallons used for each tankful. The script should 
...
# display the combined miles per gallon obtained for all tankfuls (that is, 
